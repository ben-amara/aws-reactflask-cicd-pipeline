    ...
    return (
        <Fragment>
            <div className="page-sidebar">
                <div className="main-header-left d-none d-lg-block" style={{display:'flex', alignItems:'center', justifyContent:'center', width:'100%', textAlign:'center'}}>
                    <div className="logo-wrapper compactLogo" style={{height:'100%', display:'flex', alignItems:'center', justifyContent:'center',}}>
                        <Link to={`${process.env.PUBLIC_URL}/dashboard/default`}>
                            <img className="blur-up lazyloaded" src={logo_compact} style={{width:'100px'}} alt="" />
                            <img className="blur-up lazyloaded" src={logo} style={{width:'120px'}} alt="" />
                        </Link>
                    </div>
                </div>
