...
var MENUITEMS = [
    {
        title: 'Dashboard', icon: Home, type: 'sub', badgeType: 'primary', active: false, children: [
            ...
            { path: '/dashboard/ecommerce', title: 'User', type: 'link' },
    ...
    // },
    {
        title: 'Products', icon: Book, type: 'sub', active: false, children: [
            { path: '/cards/basicCards', title: 'Create Listing', type: 'link' },
...
if (localStorage.getItem('token')){
    if (localStorage.getItem('token').includes('authenticated')){
        ...
        } else if (JSON.parse(localStorage.getItem('token'))['role'] == 'user') {
            MENUITEMS = [
                { title: 'Dashboard', icon: Home, type: 'link', path: '/dashboard/ecommerce', badgeType: 'primary'}
            ]
        } else if (JSON.parse(localStorage.getItem('token'))['role'] == 'assistant'){
