...
import { configureFakeBackend ,authHeader } from "./services/fack.backend";
...
const Root = () => {
    ...
    var [authenticated,setAuthenticated] = useState(true)
    ...
    useEffect(() => {
        if ((localStorage.getItem('token')) && (localStorage.getItem('token'))['authenticated']){
        ...
        document.getElementById("color").setAttribute("href", 'https://www.autoecom.org/api/assets/css/${color}.css');
                            ...
                            {currentUser !== null || authenticated || jwt_token ?
                                ...
                                <App>
                                    ...
                                    <Route exact path={`${process.env.PUBLIC_URL}/`} render={() => {
                                        return (<Redirect to={`${process.env.PUBLIC_URL}/dashboard/ecommerce`} />)
                                    }} />
